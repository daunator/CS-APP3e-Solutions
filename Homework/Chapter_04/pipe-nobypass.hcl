...
bool F_stall =
	...
	(E_icode in { IRRMOVQ, IIRMOVQ, IOPQ, ICALL, IPUSHQ, IPOPQ } && E_dstE in { d_srcA, d_srcB } ||
	 E_icode in { IMRMOVQ, IPOPQ } && E_dstM in { d_srcA, d_srcB } ) ||
	(M_icode in { IRRMOVQ, IIRMOVQ, IOPQ, ICALL, IPUSHQ, IPOPQ } && M_dstE in { d_srcA, d_srcB } ||
	 M_icode in { IMRMOVQ, IPOPQ } && M_dstM in { d_srcA, d_srcB } ) ||
	(W_icode in { IRRMOVQ, IIRMOVQ, IOPQ, ICALL, IRET, IPUSHQ, IPOPQ } && W_dstE in { d_srcA, d_srcB } ||
